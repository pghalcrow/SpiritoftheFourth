...
def main():
    parser = argparse.ArgumentParser(description="Rename stored parade submission titles.")
    ...
    matches = [item for item in submissions if item.get("submissionTitle") in TITLE_REPLACEMENTS]
    ...
    for item in matches:
        ...
        result = table.update_item(
            ...
            ExpressionAttributeValues={":submissionTitle": TITLE_REPLACEMENTS[item["submissionTitle"]]},
